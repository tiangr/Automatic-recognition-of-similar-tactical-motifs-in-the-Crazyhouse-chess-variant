...
OUT_JSONL   = ROOT / "data" / "derived" / "checkmates5_verified.jsonl"
...
MOVETIME_MS     = 20000  # 20s per position
START_FROM_GAME = 1      # change to resume from a specific game number
